...
const WelcomePage = () => {
	...
	return (
		<div className={styles.homeCentered}>
			...
			<Typography>
				You can search through our data of beer and breweries and create lists for yourself to keep
				a journal of your drinking journey. There are so many beers out there, so why not create a
				list of one you'd like to try? Or how about breweries you'd like to visit? And we've all had
